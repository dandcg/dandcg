...
<p>
  <a href="https://dbhq.uk"><img src="https://img.shields.io/badge/dbhq.uk-2B6BF3?style=flat-square&logo=googlechrome&logoColor=white" alt="Website"></a>
  <a href="https://www.linkedin.com/in/danielgrimes/"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=flat-square&logo=linkedin&logoColor=white" alt="LinkedIn"></a>
  <a href="mailto:dan@dbhq.uk"><img src="https://img.shields.io/badge/dan@dbhq.uk-0B0E14?style=flat-square&logo=maildotru&logoColor=white" alt="Email"></a>
</p>
...
**Open to** fixed-price delivery and senior-engineer retainers, remote-first from the UK.

### Stack

<div align="center">
  <img src="https://skillicons.dev/icons?i=cs,dotnet,go,rust,python,typescript,js,html,azure,aws,terraform,ansible,kubernetes,docker,githubactions,azuredevops,postgres,redis,git,powershell,bash,css,openai,anthropic&theme=dark&perline=8" alt="Tech stack" />
</div>

<br>

**Languages** &middot; C# &middot; Go &middot; Rust &middot; Python &middot; TypeScript / JavaScript &middot; T-SQL &middot; HCL &middot; Bicep &middot; PowerShell &middot; Bash &middot; HTML / CSS<br>
**.NET** &middot; ASP.NET Core &middot; Blazor &middot; ServiceStack<br>
**Cloud & DevOps** &middot; Azure &middot; AWS &middot; Terraform &middot; Ansible &middot; Kubernetes (AKS) &middot; Docker &middot; GitHub Actions &middot; Azure DevOps<br>
...
<div align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/grinidx/grinidx/output/github-snake-brand.svg">
